...
const contact = await msg.getContact();
        const userId = msg.from; // This actually NEVER has spaces (e.g., "919399238599@c.us")
...
const TARGET_NAMES = ["Rakesh", "Aditya", "Pushpit", "Aniket", "Kartikey", "saksham","Riya","8103155566", "9993425432","9039927001","9302974700","9093696238","9863560836","9131389947","8319657105", "9399238599", "paridhi","7000896727","26569338843245", "hemanshi" ];
...
const isTarget = TARGET_NAMES.some(target => 
    ...
    userId.includes(target)
            ...
            if (isTarget) {
                    console.log(`📩 Message from ${rawName}: "${msg.body}"`);
